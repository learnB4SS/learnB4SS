...
**If you get stuck** at any point in the installation process, please contact us at learb4ss@gmail.com as soon as possible.
...
To install the **Xcode Command Line Tools**, run the following in the terminal:
...
You need to install **gfortran v8.2** (for Mojave) <u>**independent of your macOS version**</u>.
You can download the installer from <https://github.com/fxcoudert/gfortran-for-macOS/releases/tag/8.2>.

Now you can set some compiler optimisations to improve compilation speed.

...
We have also already learned how to plot the posterior distributions of our population-level coefficients: 
...
If you want to add the actual aggregated accuracy for each listener to the plot, you can create a really informative plot.
